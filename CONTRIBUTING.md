...
- After changing a static asset, run `python3 scripts/version-assets.py` to update its content-hashed URL in index.html. Validation checks this to prevent mixed cached releases.
